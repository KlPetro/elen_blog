<div class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url( <?php if (isset($_COOKIE['user'])) {
                                                                                    echo $user['avatar'];
                                                                                } else {
    ...
    <div class="js-fullheight d-flex justify-content-center align-items-center">
        <div class="col-md-8 text text-center">
            <div class="img mb-4" style="background-image: url( <?php if (isset($_COOKIE['user'])) {
                                                                    echo $user['avatar'];
                                                                } else {
                                                                    echo 'assets/images/avatar.jpg';
                                                                }
